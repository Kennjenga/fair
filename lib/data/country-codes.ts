/**
 * E.164 country calling codes for phone inputs.
 * Format: { value: '+NN', label: 'Country Name (+NN)' }.
 * Sorted by country name for consistent display and search.
 */
export const COUNTRY_CODES: ReadonlyArray<{ value: string; label: string }> = [
